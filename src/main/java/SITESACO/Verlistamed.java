...
public class Verlistamed extends javax.swing.JFrame {
    ...
    public Verlistamed() {
        ...
        //Se llena un tabla con todos los pacientes y sus atributos principales
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Verlistamed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
